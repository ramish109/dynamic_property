    ...
    $(function() {
    var numberOfItems = $(".featured-article .wp-blocks").length;
    ...
    $(".featured-article .wp-blocks").hide().slice((currentPage - 1) * limitPerPage, currentPage *
    limitPerPage).show();
    ...
    $(".featured-article .wp-blocks").show();
    showPage(1);
