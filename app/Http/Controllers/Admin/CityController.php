...
//        $this->middleware('isApprove', ['only' =>['edit','update','destroy']]);
    ...
    public function store(Request $request)
    {
        ...
        // dd($request->all());
        // $dt = new areas();
        // $dt->name = ($getCity) ? $getCity->id : null;
        // $dt->city_id = ($getCity) ? $getCity->state_id : null;
        // $dt->state_id = ($getCity) ? $getCity->country_id : null;
        // $dt->country_id = ($request->property_type) ? $request->property_type : null;
        // $dt->status = 1;
        // $dt->save();
