                ...
                <div class="col-md-12">
                    <div class="db-add-list-wrap">
                        ...
                        <div class="db-add-listing">
                            <form action="{{route('admin.areas.update',$areas[0]->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <input type="hidden" name="local" value="{{$locale}}">
                                <input type="hidden" name="city_id" value="{{$city_id_hidden}}">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="name" class="listing-input hero__form-input  form-control custom-select" id="city">
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="area" class="form-control filter-input {{ $errors->has('name') ? 'has-error' : '' }}" 
                                            placeholder="Area Name" @if(isset($cityTranslation->name)) value="{{$areas[0]->name}}" @else value="" @endif>
