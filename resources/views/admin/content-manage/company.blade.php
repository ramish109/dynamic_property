                ...
                <div class="col-md-12">
                    <div class="invoice-panel">
                        ...
                        <div class="act-title d-flex justify-content-between">
                            <h5>Company links</h5><br>
                            <a href="{{route('admin.contentcreate', 'company')}}" class="btn v3"  data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Add Link</a>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>                                          
                                                <div class="d-flex justify-content-center">
                                                    <form action="{{route('admin.linkdestroy',$company->id)}}" method="GET">
                                                        {{csrf_field()}}
                                                        {{method_field("DELETE")}}
