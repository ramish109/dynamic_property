                ...
                <div class="col-md-12">
                    ...
                    <div class="db-add-list-wrap">
                        ...
                        <div class="db-add-listing">
                            <div class="row">
                                        ...
                                        <select name="package_id" class="listing-input hero__form-input  form-control custom-select">
                                            ...
                                            @foreach($packages as $package)
                                                ...
                                                {{-- <option value="{{$package->id}}" {{ old('package_id') == $package->id ? "selected" : "" }}>{{$package->package->packageTranslation->name}}</option>--}}
                                                    <option value="{{$package->id}}" {{ old('package_id') == $package->id ? "selected" : "" }}>{{$package->package->name}}</option>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Project Title</label> <span class="text-danger">*</span>
                    ...
                    <div class="db-add-list-wrap">
                        ...
                        <div class="db-add-listing">
                            <div class="row mb-30">
                                <!-- <div class="col-md-4">
                                    <label>Project ID</label> <span class="text-danger">*</span>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="thumbnail" class="form-control" id="photo-upload" accept="image/png, image/jpeg, image/jpg">
                                        @error('thumbnail')
                                        <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
