                                    ...
                                    <div class="col-md-4 offset-md-4">
                                        ...
                                        <div class="edit-profile-photo">
                                            @if(file_exists( public_path() . '/images/users/'.$agent->image) && $agent->image != null )
                                                <img loading="lazy" src="{{URL::asset('/images/users/'.$agent->image)}}" alt="user image"  class="preview-image-before-upload">
                                            @else
                                            ...
                                            <div class="change-photo-btn">
                                                <div class="contact-form__upload-btn xs-left">
                                                    <input class="contact-form__input-file" type="file" name="image" id="photo-upload" accept="image/png, image/jpeg, image/jpg" value="{{$agent->image}}">
                                                    <span>
                                                    Upload Photos
                                                </span>
                                                </div>
