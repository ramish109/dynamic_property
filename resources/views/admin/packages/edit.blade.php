                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="listing-input hero__form-input  form-control custom-select {{ $errors->has('currency_id') ? 'has-error' : '' }}" name="currency_id">
                                            ...
                                            <option value="3" {{$package->currency_id == 3 ? 'selected' : ''}}>NAIRA</option>
                                        </select>
                                    ...
                                    <div class="col-md-4">
                                      ...
                                      <div class="col-md-4">
                                        ...
                                        <input type="number" name="gallery_images_limit" value="{{$package->gallery_images_limit}}" class="form-control filter-input" placeholder="Images upload limit ">
                                    </div>
