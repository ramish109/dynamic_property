...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(GateContract $gate)
    {
        ...
        //Check for Builder
        //Return true if auth user type is builder
        $gate->define('isBuilder',function($user){
        ...
        //Return true if auth user type is Individual 
        $gate->define('isIndividual',function($user){
        ...
        $gate->define('zeroCredit',function($user){
         ...
         $gate->define('hasListing',function($user){
            if($user->type == 'owner'){
                return true;
            }
        });
