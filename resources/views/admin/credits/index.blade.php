                                        ...
                                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <div class="pricing-table">
                                                ...
                                                <div class="price-value">
                                                    <div class="price-num">
                                                        <div class="price-num-item"><span class="mouth-cont"><span class="curen">₦</span>{{($package->is_free == 1)?'0.00': $package->price}}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <ul class="pricing-content">
                                                    ...
                                                    <li><span>{{$package->gallery_images_limit}}</span>  Gallery Image Limit</li>
                                                    <li>Property Request View</li>
                                                </ul>
                                                @php
