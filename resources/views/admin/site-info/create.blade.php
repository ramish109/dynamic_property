                    ...
                    <div class="db-add-list-wrap">
                        ...
                        <div class="db-add-listing">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="list_info">Faqs</label> <span class="text-danger">*</span>
                                        <textarea name="faqs" class="form-control" id="list_info" rows="4" placeholder="Enter your text here">{{isset($siteInfo->faqs) ? $siteInfo->faqs : 'faqs'}}</textarea>
                                        <!-- @error('faqs')
                                        <p class="text-danger">{{$message}}</p>
                                        @enderror -->
                                    </div>
